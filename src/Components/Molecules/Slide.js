...
import PatternBg from "../../assets/Testimonial/pattern-bg.svg";
import PatternQuotes from "../../assets/Testimonial/pattern-quotes.svg";
...
function Slide(props) {
    ...
    const { name, active, id, description, img } = props; 
    return (
        <StyledSlide>
            <SlideText>
                <p>{description}</p>
